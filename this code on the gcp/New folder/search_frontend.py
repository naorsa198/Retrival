...
from inverted_index_gcp import InvertedIndex as Inverted_index_body, MultiFileReader
...
inverted = Inverted_index_body.read_index('/home/naorsa/postings_gcp_body/postings_gcp/', 'index')
...
inverted_index_anchor =inverted_index_anchor.read_index('/home/naorsa/postings_gcp_anchor/postings_gcp', 'anchor_index')
